...
import {
  ...
  encodeSvgMetadata,
  decodeSvgMetadata,
} from "@editor/io/image";
import { serializeAsJSON } from "@editor/io/json";
import { exportToSvg } from "@editor/scene/export";
import { FileId } from "@editor/elements/types";
import { getDataURL } from "@editor/io/blob";
