...
import { ShortcutName } from "@editor/actions/shortcuts";
import { copiedStyles } from "@editor/actions/actionStyles";
import { API } from "../helpers/api";
import { setDateTimeForTests } from "@shared/lib/utils";
import { t } from "@shared/i18n";
import { LibraryItem } from "@editor/state/types";
import { getWorkspaceTestState } from "../helpers/workspaceTestState";
...
describe("contextMenu element", () => {
  ...
  it("selecting 'Add to library' in context menu adds element to library", async () => {
    ...
    await waitFor(() => {
      const libraryItems = getWorkspaceTestState().libraryItems || [];
