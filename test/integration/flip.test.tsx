...
import { actionFlipHorizontal, actionFlipVertical } from "@editor/actions";
import { getElementAbsoluteCoords } from "@editor/elements";
import {
  ExcalidrawElement,
...
import { newLinearElement } from "@editor/elements";
import ExcalidrawApp from "@app/HandrawApp";
import { mutateElement } from "@editor/elements/mutateElement";
import { DataURL, NormalizedZoomValue } from "@editor/state/types";
import { MIME_TYPES, ROUNDNESS } from "@editor/state/constants";

const { h } = window;

const mouse = new Pointer("mouse");
jest.mock("@editor/io/blob", () => {
  const originalModule = jest.requireActual("@editor/io/blob");
