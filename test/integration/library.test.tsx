...
import { LibraryItem, LibraryItems } from "@editor/state/types";
import { UI } from "../helpers/ui";
import { serializeLibraryAsJSON } from "@editor/io/json";
import { distributeLibraryItemsOnSquareGrid } from "@editor/io/library";
import { ExcalidrawGenericElement } from "@editor/elements/types";
import { getCommonBoundingBox } from "@editor/elements/bounds";
import { parseLibraryJSON } from "@editor/io/blob";
import { fileOpen } from "@renderer/platform/electron/api/filesystem";
...
jest.mock("@renderer/platform/electron/api/filesystem", () => ({
  __esmodule: true,
  ...jest.requireActual("@renderer/platform/electron/api/filesystem"),
