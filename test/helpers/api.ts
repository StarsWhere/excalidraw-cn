...
import { newElement, newTextElement, newLinearElement } from "@editor/elements";
import { DEFAULT_VERTICAL_ALIGN, ROUNDNESS } from "@editor/state/constants";
import { getDefaultAppState } from "@editor/state/appState";
import { GlobalTestState, createEvent, fireEvent } from "./test-utils";
import fs from "fs";
import util from "util";
import path from "path";
import { getMimeType } from "@editor/io/blob";
import { newFreeDrawElement, newImageElement } from "@editor/elements/newElement";
import { Point } from "@editor/state/types";
import { getSelectedElements } from "@editor/scene/selection";
import { isLinearElementType } from "@editor/elements/typeChecks";
