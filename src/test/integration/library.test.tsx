...
import { LibraryItem, LibraryItems } from "../../core/editor/state/types";
import { UI } from "../helpers/ui";
import { serializeLibraryAsJSON } from "../../core/editor/io/json";
import { distributeLibraryItemsOnSquareGrid } from "../../core/editor/io/library";
import { ExcalidrawGenericElement } from "../../core/editor/elements/types";
import { getCommonBoundingBox } from "../../core/editor/elements/bounds";
import { parseLibraryJSON } from "../../core/editor/io/blob";
...
jest.mock("../../platform/desktop/api/filesystem", () => ({
  __esmodule: true,
  ...jest.requireActual("../../platform/desktop/api/filesystem"),
