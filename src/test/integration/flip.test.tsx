import { GlobalTestState, render, waitFor } from "../helpers/test-utils";
import { UI, Pointer } from "../helpers/ui";
import { API } from "../helpers/api";
import { actionFlipHorizontal, actionFlipVertical } from "../../core/editor/actions";
import { getElementAbsoluteCoords } from "../../core/editor/elements";
import {
  ExcalidrawElement,
...
import { newLinearElement } from "../../core/editor/elements";
import ExcalidrawApp from "../../app/desktop/shell/DesktopApp";
import { mutateElement } from "../../core/editor/elements/mutateElement";
import { DataURL, NormalizedZoomValue } from "../../core/editor/state/types";
import { MIME_TYPES, ROUNDNESS } from "../../core/editor/state/constants";

const { h } = window;

const mouse = new Pointer("mouse");
jest.mock("../../core/editor/io/blob", () => {
  const originalModule = jest.requireActual("../../core/editor/io/blob");
