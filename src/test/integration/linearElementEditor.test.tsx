...
import ExcalidrawApp from "../../app/desktop/shell/DesktopApp";
import { centerPoint } from "../../shared/lib/math";
import { reseed } from "../../shared/lib/random";
import * as Renderer from "../../core/editor/render/renderScene";
import { Keyboard, Pointer, UI } from "../helpers/ui";
import { screen, render, fireEvent, GlobalTestState } from "../helpers/test-utils";
import { API } from "../helpers/api";
import { Point } from "../../core/editor/state/types";
import { KEYS } from "../../shared/lib/keys";
import { LinearElementEditor } from "../../core/editor/elements/linearElementEditor";
import { queryByTestId, queryByText } from "@testing-library/react";
import { resize, rotate } from "../helpers/utils";
import { getBoundTextElementPosition, wrapText } from "../../core/editor/elements/textElement";
import { getMaxContainerWidth } from "../../core/editor/elements/newElement";
import * as textElementUtils from "../../core/editor/elements/textElement";
import { ROUNDNESS } from "../../core/editor/state/constants";
...
describe("Test Linear Elements", () => {
  ...
  it("should allow dragging line from midpoint in 2 pointer lines outside editor", async () => {
    ...
    drag(midpoint, [midpoint[0] + delta, midpoint[1] + delta]);
    expect(renderScene.mock.calls.length).toBeGreaterThanOrEqual(11);
    expect(line.points.length).toEqual(3);
  ...
  describe("Inside editor", () => {
    ...
    it("should update the midpoints when element roundness changed", async () => {
      ...
      expect(renderScene.mock.calls.length).toBeGreaterThanOrEqual(12);
    ...
    it("should update all the midpoints when element position changed", async () => {
      ...
      expect(renderScene.mock.calls.length).toBeGreaterThanOrEqual(16);
    ...
    describe("When edges are round", () => {
      ...
      it("should allow dragging lines from midpoints in between segments", async () => {
        ...
        expect(renderScene.mock.calls.length).toBeGreaterThanOrEqual(21);
      ...
      it("should remove the midpoint when one of the points in the segment is deleted", async () => {
        ...
        expect(line.points.length).toEqual(3);
        expect(renderScene.mock.calls.length).toBeGreaterThanOrEqual(22);
