import { render, waitFor, GlobalTestState } from "../helpers/test-utils";
import { Pointer, Keyboard } from "../helpers/ui";
import ExcalidrawApp from "../../app/desktop/shell/DesktopApp";
import { KEYS } from "../../shared/lib/keys";
import { getApproxLineHeight } from "../../core/editor/elements/textElement";
import { getFontString } from "../../shared/lib/utils";
import { getElementBounds } from "../../core/editor/elements";
import { NormalizedZoomValue } from "../../core/editor/state/types";

const { h } = window;

const mouse = new Pointer("mouse");

jest.mock("../../shared/lib/keys", () => {
  const actual = jest.requireActual("../../shared/lib/keys");
  return {
    __esmodule: true,
    ...actual,
    isDarwin: false,
