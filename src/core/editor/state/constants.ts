import cssVariables from "../../../shared/styles/variables.module.scss";
import { AppProps } from "./types";
import { FontFamilyValues } from "../elements/types";
...
export const EXPORT_SOURCE =
  window.EXCALIDRAW_EXPORT_SOURCE || "desktop://handraw";
