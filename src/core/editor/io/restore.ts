...
import { isTextElement, isUsingAdaptiveRadius } from "../elements/typeChecks";
...
import { bumpVersion } from "../elements/mutateElement";
import { getUpdatedTimestamp, updateActiveTool } from "../../../shared/lib/utils";
