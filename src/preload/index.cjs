...
contextBridge.exposeInMainWorld("handrawElectron", {
  isElectron: true,
  platform: process.platform,
  loadWorkspaceState: () => ipcRenderer.invoke("handraw:load-desktop-state"),
  ...
  resetWorkspaceState: () => ipcRenderer.invoke("handraw:reset-desktop-state"),
