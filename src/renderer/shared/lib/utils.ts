...
import colors from "@editor/lib/colors";
import {
  CURSOR_TYPE,
  DEFAULT_VERSION,
  EVENT,
...
import { FontFamilyValues, FontString } from "@editor/elements/types";
import { AppState, DataURL, LastActiveTool, Zoom } from "@editor/state/types";
import { unstable_batchedUpdates } from "react-dom";
import { SHAPES } from "@editor/lib/shapes";
import { isEraserActive, isHandToolActive } from "@editor/state/appState";
...
// This intentionally mirrors the upstream RTL detection ranges.
// eslint-disable-next-line no-misleading-character-class
const RE_RTL_CHECK = new RegExp(`^[^${RS_LTR_CHARS}]*[${RS_RTL_CHARS}]`, "u");
/**
